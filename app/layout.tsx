...
// block in app/globals.css is inert until something puts that class on <html>.
// Nothing ever did. Each themed app therefore shipped a complete, correct dark
// palette that could not be reached — for a dark-native theme (neon on
// near-black) the light half is the wrong face of the theme entirely.
//
...
// shipped. Design intent wins first paint; the visitor still overrides it with
  ...
  return (
    <html lang="en" className={inter.variable} suppressHydrationWarning>
      <body className="font-sans" suppressHydrationWarning>
        ...
        <IframeLoggerInit />
        {/* Mounted here, not in a page, so every generated app has a light/dark
            switch whether or not the UI generator remembered to add one. It
            hides itself when the active design system ships no dark half. */}
        <ThemeToggle />
        <SSOGuard>
          <ClientProviders>
            {children}
